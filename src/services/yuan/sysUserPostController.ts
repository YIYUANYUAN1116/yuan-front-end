...
/** 修改post-user PUT /system/sysUserPost */
...
/** 新增post-user POST /system/sysUserPost */
...
/** 获取post-user详细信息 GET /system/sysUserPost/${param0} */
...
/** 删除post-user DELETE /system/sysUserPost/${param0} */
...
/** 导出post-user列表 POST /system/sysUserPost/export */
...
/** 查询post-user列表 GET /system/sysUserPost/list */
